...
//        addShape()
    ...
    private func setupViewControllers() {
        ...
        viewControllers = [firstVC, twoVC, threeVC, fourtVC,five]
    }
    ...
    private func configureTabBarAppearance() {
        ...
        // Create a UITabBarAppearance instance
          ...
          appearance.backgroundColor = .blue // Background color of the tab bar
          ...
          tabBar.backgroundColor = .blue // Background color of the tab bar
